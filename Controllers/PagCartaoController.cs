...
{
    public class PagCartaoController : Controller
    {
        private readonly MyDbContext _context;

        public PagCartaoController(MyDbContext context)
        {
            _context = context;
        }
        ...
        // GET: PagCartao/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: PagCartao/Create
