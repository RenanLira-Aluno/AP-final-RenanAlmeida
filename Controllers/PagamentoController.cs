...
namespace RenanAlmeida.Controllers
{
    public class PagamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Valor,DataLimite,Pago,NotaDeVendaId")] Pagamento pagamento)
        {
            ...
            ViewData["NotaDeVendaId"] = new SelectList(_context.NotasDeVenda, "Id", "Id", pagamento.NotaDeVendaId);
            return View(pagamento);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Valor,DataLimite,Pago,NotaDeVendaId")] Pagamento pagamento)
        {
            if (id != pagamento.Id)
            {
                return NotFound();
