...
{
    public class PagChequeController : Controller
    {
        private readonly MyDbContext _context;

        public PagChequeController(MyDbContext context)
        {
            _context = context;
        }
        ...
        // GET: PagCheque/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: PagCheque/Create
